...
function customObjectFromEntries(entries) {
	...
	let processedEntries = entries.map(function (entry) {
		let key = entry[0];
		let value = entry[1];
...
function keysAndValues(obj) {
	...
	return Array(Object.keys(obj), Object.values(obj))
}
...
function filterObjectsByKey(arr, key) {
	...
	let filteredObjects = arr.filter(function (obj) {
...
function getObjectValuesSum(obj) {
	...
	const sumWithInitial = arrValues.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
